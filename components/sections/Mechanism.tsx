...
const pillars = [
  {
    ...
    body: 'Только 3% кандидатов получают право проводить занятия. Каждый проходит месячный буткемп: подача материала, работа с тревожным учеником, удержание внимания класса. К ученикам попадают только лучшие.',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-dark">
            Почему 93% учеников доходят до экзамена?
          </h2>
