...
const pillars = [
  ...
  {
    icon: MessageCircle,
    title: 'Ваш ребёнок не будет «тихим в углу»',
    body: 'В маленькой группе не получится промолчать весь урок и не понять тему. Преподаватель распределяет вопросы и задания равномерно — каждый ученик думает, отвечает и разбирает ошибки.',
    badge: 'Баланс в группе',
  },
  {
    icon: Users,
    title: 'Группа, в которой преподаватель знает каждого ученика',
