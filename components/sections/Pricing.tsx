    ...
    <section className="bg-[#F0F2F5] py-16 md:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-[42px] font-bold text-dark leading-tight max-w-2xl mx-auto">
            Подберите формат<br className="hidden sm:block" /> под свою цель
          </h2>
          <p className="mt-3 text-muted text-lg">Все тарифы включают гарантию результата в договоре</p>
        </div>
